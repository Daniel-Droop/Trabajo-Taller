...
namespace ejercicio_12
{
    class Program
    {
        ...
        {
            // use  la misma estructura del ejercicio anterior ya que es algo muy parecido asi que partiendo de la misma estrucutura declaro las variables filas y columnas 
            int filas;
            int columnas;
            ...
            // como en los anteriores ejercicios uso la variable f y c para no confundirme 
            ...
            // ahora luego de llenar la matrzi 1 llenamos la matriz 2 de la misma manera debe tener las mismas filas y columnas para poder realizar la divison  de otra forma solo imprimira la matriz 2 resultante
            Console.WriteLine("");
            ...
            // acontinuacuon vamos a dividir por 2 cada elemento y luego sumarlo ejemplo es dividir el elemento 1,1 de la matriz 1 por 2 y luego dividir el elemento (1,1) de la matriz 2 por 2 y sumar ambos resultados y asi con cada elemento 
            Console.WriteLine(" ");
            Console.WriteLine("La division por 2  de cada elemento de las dos matrices y su respectiva suma  es de: ");
            Console.WriteLine(" ");
            ...
            for (int f = 0; f < matriz1.GetLength(0); f++)
            {
                for (int c = 0; c < matriz1.GetLength(1); c++)
                {
                    matriz3[f, c] = (matriz1[f, c] / 2) + (matriz2[f, c] / 2);
