...
//Escriba una rutina que reciba dos Pilas P1 y P2 de números enteros y proceda a intercambiar
//sus elementos, pero manteniendo el orden de salida de los elementos. Al finalizar la rutina,
//la Pila P1 tendrá los elementos de la Pila P2 y esta a su vez tendrá los elementos de la
//Pila P1.

namespace Ejercicios_pilas_Nu4
{
    class Program
    {
