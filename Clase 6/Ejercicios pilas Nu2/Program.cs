...
namespace Ejercicios_pilas_Nu2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (pilap.Count > 0)
            {
                pilaax.Push(pilap.Pop());

            }

            // una vez movidos los datos a la nueva pila procedemos a limpiar la pila P con el metodo clear y procedemos a imprimir por pantalla los datos ingresados invirtiendo su orden
            ...
            pilap.Clear();
            Console.WriteLine("");
            Console.WriteLine("los datos en una nueva pila con el orden invertido ");


            while (pilaax.Count > 0)
            {

                Console.Write("," + pilaax.Pop());
