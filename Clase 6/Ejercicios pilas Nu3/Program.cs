...
//3.Escriba una rutina que reciba dos Pilas P1 y P2 de números flotantes y apile las mismas
//en una nueva Pila resultante. Es de destacar que las Pilas recibidas no deben sufrir
//ningún tipo de cambio o alteración.
namespace Ejercicios_pilas_Nu3
{
    class Program
    {
