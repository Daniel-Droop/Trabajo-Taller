...
//Escriba una rutina que reciba una ColaC de números flotantes y devuelva una  Pila, 
//manteniendo el orden de salida de los elementos.Es de destacar que la ColaC no debe 
...
namespace Ejercicio_13
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.ReadKey();
            // profe este ejercicio me gustaria que lo hicieras en clase ya que no me fue tan facil hacerlo y al momento de copiar a la pila no se 
            //si enrealidad se copean los elememtos 
        }
    }
}